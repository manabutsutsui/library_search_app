...
final List<AnimeList> animeList = [
  ...
  AnimeList(
    name: '鬼滅の刃',
    genre: 'アクション/バトル SF/ファンタジー ドラマ/青春',
  ...
  AnimeList(
    name: '呪術廻戦',
    genre: 'SF/ファンタジー アクション/バトル ホラー/サスペンス/推理',
  ...
  AnimeList(
    ...
    genre: 'SF/ファンタジー 恋愛/ラブコメ ドラマ/青春',
