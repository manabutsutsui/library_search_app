                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      const CircleAvatar(
                        backgroundImage:
                            AssetImage('assets/icon/seichi_icon.png'),
                      ),
                        ...
                        return Column(
                          children: [
                            ...
                            Consumer(
                              builder: (context, ref, child) {
                                final isSubscribed =
                                    ref.watch(subscriptionProvider).value ==
                                        true;
                                return isSubscribed
                                    ? const Divider(height: 1, thickness: 1)
                                    : const AdBanner();
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    title: Text(user['username'] ?? l10n.unknownUser),
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => OtherUserProfilePage(
                            userId: user.id,
                            userName: user['username'] ?? l10n.unknownUser,
